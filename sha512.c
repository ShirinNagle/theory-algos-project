...
// Page 11 of the secure hash standard. Note the functions CH & MAJ are the same for SHA256.
...
int next_block(FILE *f, union Block *M, enum Status *S, uint64_t *nobits) {
    ...
    // More logic to go here....check the paramaters ...what they should be..
    //Check back on lab videos for preprocessing to understand what is happening here.
